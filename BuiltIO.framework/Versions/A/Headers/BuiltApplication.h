...
/**
 ...
 @discussion Since this method returns an object of BuiltQuery class, all the methods of the BuiltQuery class are available and can be used to query the Application user class of built.io
 */
- (BuiltQuery *)applicationUsersQuery;
